  ...
  body {
    ...
    section.about {
      ...
      .card {
        ...
        p {
          content: "I’m Sean, a first-year undergraduate at UC San Diego majoring in ";
          a.link[href="https://sheeptester.github.io/longer-tweets/major/"][title="might still switch into CE"] {
            content: "computer science*";
          }
          content: " and graduating in 2025, formerly a student at ";
          a.link[href="https://gunn.pausd.org/"] {
            content: "Gunn High School";
          }
          content: ".";
        }
        css {
      ...
      .card {
        ...
        a.discord-link.block-link[href="https://discord.gg/srtYgbVw4H"] {
          css {
            .discord-text {
              flex: auto;
            }
    ...
    section.project-wrapper {
          ...
          .description-body {
            ...
            .description-header {
              ...
              css {
                ...
                .desc-visit:hover {
                  background-color: rgba(28, 224, 224, 0.1);
                }
              }
      ...
      p.tinder-note {
        ...
        a.link[href="./all/tinder.html"] {
          content: "Expore and sort through everything else.";
        }
      }
    }
