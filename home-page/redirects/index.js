...
(function() {
  ...
  if (window.location.search) {
    ...
    else if (redirect.slice(0, 2).toLowerCase() === 'rr') window.location.replace('/home-page/redirects/LE0xyc4dgp.mp4');
    else if (redirect.slice(0, 2).toLowerCase() === 'js') window.location.replace('/home-page/redirects/jeff.mp4');
    else if (redirect.slice(0, 3).toLowerCase() === 'try') window.location.replace('https://www.google.com/search?udm=2&q=trypophobia');
